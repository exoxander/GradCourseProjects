 ...
 *
 *  DepthFirstSearch.str() has been modifed to print the types of each vertexes
 *	edges along with the tree
 * 
 ******************************************************************************/
...
public:
  ...
  //returns a string including each vertex's properties
  //and the type of edges from that vertex to other tree elements
